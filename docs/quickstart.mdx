...
Get your documentation site running locally and make your first bingo.
...
<Note>
  **Example XML feed**: <a href="/feed.xml" download>Download feed.xml</a> to see how static XML files are served.
</Note>
