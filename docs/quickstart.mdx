...
Get your documentation site running locally to make your changes. The best way to do this is following each step in the right order; laying a good foundation here will pay dividends. Make sure you have a good understanding of the steps before you move on to the next one.
